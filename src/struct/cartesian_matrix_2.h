...
public:
    ...
    dtype getDeterminant(){
        return xx * yy * zz + xy * yz * zx + xz * yx * zy - xz * yy * zx - xy * yx * zz - xx * yz * zy;
    }

    CARTESIAN_MATRIX_2& operator+= (CARTESIAN_MATRIX_2 const& cCoordIN){
        this->xx += cCoordIN.xx;
        this->xy += cCoordIN.xy;
        this->xz += cCoordIN.xz;
        this->yx += cCoordIN.yx;
    ...
    CARTESIAN_MATRIX_2& operator+= (double const& doubleIN){
        return *this += CARTESIAN_MATRIX_2(doubleIN);
    };
    ...
    friend CARTESIAN_MATRIX_2 operator+ (CARTESIAN_MATRIX_2 const& lhs, CARTESIAN_MATRIX_2 const& rhs){
        CARTESIAN_MATRIX_2 result;
    ...
    friend CARTESIAN_MATRIX_2 operator+ (double const& lhs, CARTESIAN_MATRIX_2 const& rhs){
        CARTESIAN_MATRIX_2 result;
    ...
    friend CARTESIAN_MATRIX_2 operator+ (CARTESIAN_MATRIX_2 const& lhs, double const& rhs){
        CARTESIAN_MATRIX_2 result;
        result = rhs + lhs;
        return result;
    };
    friend CARTESIAN_MATRIX_2 operator+ (dtype const& lhs, CARTESIAN_MATRIX_2 const& rhs){
        CARTESIAN_MATRIX_2 result;
        result.xx = lhs + rhs.xx;
        result.xy = lhs + rhs.xy;
        result.xz = lhs + rhs.xz;
    ...
    friend CARTESIAN_MATRIX_2 operator+ (CARTESIAN_MATRIX_2 const& lhs, dtype const& rhs){
        CARTESIAN_MATRIX_2 result;
        result = rhs + lhs;
        return result;
    };
    ...
    friend ostream& operator<< (ostream& lhs, CARTESIAN_MATRIX_2 const& rhs){
        return lhs << rhs.xx << "\t" << rhs.xy << "\t" << rhs.xz << "\n" << rhs.yx << "\t" << rhs.yy << "\t" << rhs.yz << "\n" << rhs.zx << "\t" << rhs.zy << "\t" << rhs.zz;
    }

    friend bool operator== (const CARTESIAN_MATRIX_2& lhs, const CARTESIAN_MATRIX_2& rhs){
